...
// Set
const currenciesUnique = new Set(['USD', 'BFR', 'USD', 'ESP', 'BFR']);
...
// Task
const w = Array.from({ length: 100 }, () => Math.trunc(Math.random() * 6) + 1);
console.log(w);
...
// 1.
const bandkDepositSum = accounts
  .flatMap(acc => acc.movements)
  .filter(mov => mov > 0)
  .reduce((sum, cur) => sum + cur, 0);

console.log(bandkDepositSum);
...
// 8.
// Sorting according to recommended food
